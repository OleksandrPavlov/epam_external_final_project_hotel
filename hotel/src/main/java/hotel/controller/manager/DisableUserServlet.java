...
@WebServlet(urlPatterns = "/manager/pended/discard")
public class DisableUserServlet extends AbstractServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            getHotelManagerService().disableUser(Integer.parseInt(req.getParameter("userId")));
